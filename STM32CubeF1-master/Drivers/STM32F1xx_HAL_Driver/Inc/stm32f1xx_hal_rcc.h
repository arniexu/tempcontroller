...
#define __HAL_RCC_GPIOB_CLK_ENABLE() do { SET_BIT(RCC->APB2ENR, RCC_APB2ENR_IOPBEN); (void)READ_REG(RCC->APB2ENR); } while (0)
#define __HAL_RCC_GPIOC_CLK_ENABLE() do { SET_BIT(RCC->APB2ENR, RCC_APB2ENR_IOPCEN); (void)READ_REG(RCC->APB2ENR); } while (0)
