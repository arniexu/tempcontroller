#ifndef PROJECT_CONFIG_EDGEGATEWAY_H
#define PROJECT_CONFIG_EDGEGATEWAY_H

/* EdgeGateway project profile (hardware target: STM32F407VGT6). */
...
#define COMP_ETHERNET_ENABLE              (1U)
